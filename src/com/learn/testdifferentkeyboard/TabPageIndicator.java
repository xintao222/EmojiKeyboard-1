...
public class TabPageIndicator extends HorizontalScrollView implements PageIndicator {
	...
	private int mMaxTabWidth, mSelectedTabIndex, mService;
	...
	public void setCurrentItem(int item) {
		...
		for (int i = 0; i < tabCount; i++) {
			...
			if (isSelected) {
				...
				switch(mService) {
				case 2:
					int resID = getResources().getIdentifier("tab_" + (i + 1) + "_active", "drawable", mContext.getPackageName());
				...
				switch(mService) {
				case 2:
					int resID = getResources().getIdentifier("tab_" + (i + 1), "drawable", mContext.getPackageName());
					child.setBackgroundResource(resID);
					break;
				}
			}			
